...
export default function LeadsList() {
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute(
      'download',
      `yellow_pages_leads_page_${page}.csv`
    );
            ...
            <tbody className="divide-y divide-slate-100 text-slate-700">
              {loading ? (
                ...
                leads.map((lead) => {
                  const isLocked =
                    lead.lock?.isLocked &&
                    new Date(lead.lock.lockExpiresAt) > new Date();
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3 px-4">
                        <div
                          className="font-semibold text-slate-900 hover:text-amber-600 cursor-pointer"
                          onClick={() =>
                      ...
                      <td className="py-3 px-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          {isLocked && (
                            <span
                              title={`Currently locked by ${
                                lead.lock?.lockedBy?.name ||
                                'an agent'
                              }`}
      ...
      >
        <div className="space-y-4">
          <p className="text-xs text-slate-600">
            Select a target employee or caller to reassign these{' '}
            {selectedIds.length} leads. Previous ownership and
            activities will be preserved immutably.
          </p>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              ...
              >
                ...
                <option value="Automobiles & Services">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:border-amber-500 focus:outline-none"
              >
                <option value="YELLOW_PAGES">
                  Yellow Pages Directory
                </option>
                <option value="WEBSITE">
                  Website Lead Form
                </option>
                <option value="EXCEL_IMPORT">
                  Excel/Data Import
                </option>
