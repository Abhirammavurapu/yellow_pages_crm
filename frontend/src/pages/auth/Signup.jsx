...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.role === 'ADMIN' && !form.adminKey.trim()) {
      setErrorMsg(
        'Please enter the Admin Security Key (default: ADMIN2024)'
      );
      return;
    }
    ...
    try {
      ...
      setSuccessMsg(
        'Account created successfully! Redirecting to CRM...'
      );
          ...
          {form.role === 'ADMIN' && (
            <div className="mb-4 p-3 bg-amber-500/10 border border-amber-500/30 rounded-xl space-y-2 text-xs">
              ...
              <p className="text-[11px] text-slate-400">
                To create a high-privilege Administrator account, enter the
                Admin Passkey (default:{' '}
